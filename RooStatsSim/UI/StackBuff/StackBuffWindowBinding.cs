...
namespace RooStatsSim.UI.StackBuff
{
    class MedalList : ObservableCollection<AbilityBinding<int>>
    {
        ...
        public MedalList(ref UserData param_status)
        {
            ...
            Add(new AbilityBinding<int>(EnumBaseTable_Kor.MEDAL_ENUM_KOR[MEDAL_ENUM.VALOR], medal.List[(int)MEDAL_ENUM.VALOR], 0, Enum.GetName(typeof(MEDAL_ENUM), MEDAL_ENUM.VALOR)));
            Add(new AbilityBinding<int>(EnumBaseTable_Kor.MEDAL_ENUM_KOR[MEDAL_ENUM.GUARDIAN], medal.List[(int)MEDAL_ENUM.GUARDIAN], 0, Enum.GetName(typeof(MEDAL_ENUM), MEDAL_ENUM.GUARDIAN)));
            Add(new AbilityBinding<int>(EnumBaseTable_Kor.MEDAL_ENUM_KOR[MEDAL_ENUM.WISDOM], medal.List[(int)MEDAL_ENUM.WISDOM], 0, Enum.GetName(typeof(MEDAL_ENUM), MEDAL_ENUM.WISDOM)));
            Add(new AbilityBinding<int>(EnumBaseTable_Kor.MEDAL_ENUM_KOR[MEDAL_ENUM.CHARM], medal.List[(int)MEDAL_ENUM.CHARM], 0, Enum.GetName(typeof(MEDAL_ENUM), MEDAL_ENUM.CHARM)));
            Add(new AbilityBinding<int>(EnumBaseTable_Kor.MEDAL_ENUM_KOR[MEDAL_ENUM.GALE], medal.List[(int)MEDAL_ENUM.GALE], 0, Enum.GetName(typeof(MEDAL_ENUM), MEDAL_ENUM.GALE)));
        }
    }
