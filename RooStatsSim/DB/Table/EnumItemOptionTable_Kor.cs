...
namespace RooStatsSim.DB.Table
{
    class EnumItemOptionTable_Kor
    {
        ...
        public static Dictionary<DTYPE, string> DTYPE_KOR = new Dictionary<DTYPE, string>()
        {
            ...
            {DTYPE.MELEE_PHYSICAL_DAMAGE, "근거리 물리 데미지(%)" },
            {DTYPE.RANGE_PHYSICAL_DAMAGE, "원거리 물리 데미지(%)" },
            {DTYPE.CRI_DAMAGE, "크리 데미지 증가(%)" },
            {DTYPE.DEF_P, "DEF %" },
            {DTYPE.MDEF_P, "MDEF %" },
        ...
        {
            {SE_ATK_RATE_TYPE.STUN_ATK_RATE, EnumBaseTable_Kor.STATUS_EFFECT_TYPE_KOR[STATUS_EFFECT_TYPE.STUN] +STR_ATK_RATE },
            ...
            {SE_ATK_RATE_TYPE.DARKNESS_ATK_RATE, EnumBaseTable_Kor.STATUS_EFFECT_TYPE_KOR[STATUS_EFFECT_TYPE.DARKNESS] +STR_ATK_RATE },
        ...
        {
            {SE_REG_RATE_TYPE.STUN_REG_RATE, EnumBaseTable_Kor.STATUS_EFFECT_TYPE_KOR[STATUS_EFFECT_TYPE.STUN] + STR_REG_RATE },
            ...
            {SE_REG_RATE_TYPE.DARKNESS_REG_RATE, EnumBaseTable_Kor.STATUS_EFFECT_TYPE_KOR[STATUS_EFFECT_TYPE.DARKNESS] + STR_REG_RATE },
        ...
        public static Dictionary<TRIBE_DMG_TYPE, string> TRIBE_DMG_TYPE_KOR = new Dictionary<TRIBE_DMG_TYPE, string>()
        {
            ...
            { TRIBE_DMG_TYPE.FISH_DMG, EnumBaseTable_Kor.TRIBE_TYPE_KOR[TRIBE_TYPE.FISH] + STR_DMG },
            ...
            { TRIBE_DMG_TYPE.FORMLESS_DMG, EnumBaseTable_Kor.TRIBE_TYPE_KOR[TRIBE_TYPE.FORMLESS] + STR_DMG },
        ...
        public static Dictionary<TRIBE_REG_TYPE, string> TRIBE_REG_TYPE_KOR = new Dictionary<TRIBE_REG_TYPE, string>()
        {
            ...
            { TRIBE_REG_TYPE.FISH_REG, EnumBaseTable_Kor.TRIBE_TYPE_KOR[TRIBE_TYPE.FISH] + STR_REG },
            ...
            { TRIBE_REG_TYPE.FORMLESS_REG, EnumBaseTable_Kor.TRIBE_TYPE_KOR[TRIBE_TYPE.FORMLESS] + STR_REG },
